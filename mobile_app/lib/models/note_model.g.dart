...
int _noteModelEstimateSize(
  ...
  {
    final value = object.formattedText;
    if (value != null) {
      bytesCount += 3 + value.length * 3;
    }
  }
...
void _noteModelSerialize(
  ...
  writer.writeString(offsets[3], object.formattedText);
...
NoteModel _noteModelDeserialize(
  ...
  object.formattedText = reader.readStringOrNull(offsets[3]);
  object.id = id;
  object.status =
      _NoteModelstatusValueEnumMap[reader.readByteOrNull(offsets[4])] ??
          NoteStatus.draft;
...
P _noteModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 3:
      return (reader.readStringOrNull(offset)) as P;
    case 4:
      return (_NoteModelstatusValueEnumMap[reader.readByteOrNull(offset)] ??
...
const _NoteModelstatusValueEnumMap = {
  0: NoteStatus.draft,
  1: NoteStatus.processing,
  2: NoteStatus.processed,
  3: NoteStatus.archived,
  4: NoteStatus.deleted,
};
...
extension NoteModelQueryWhereSort
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhere> anyUuid() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteModelQueryWhere
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidGreaterThan(
    String? uuid, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidLessThan(
    String? uuid, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidBetween(
    String? lowerUuid,
    String? upperUuid, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidStartsWith(
      String UuidPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'uuid',
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'uuid',
        value: [''],
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterWhereClause> uuidIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension NoteModelQueryFilter
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> uuidIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'uuid',
      ));
  ...
  QueryBuilder<NoteModel, NoteModel, QAfterFilterCondition> uuidIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'uuid',
      ));
