...
import 'package:soutnote/features/admin/presentation/screens/companies_list_screen.dart';
import 'package:soutnote/features/admin/presentation/screens/users_list_screen.dart';
...
class _AdminDashboardScreenState extends State<AdminDashboardScreen> {
                                ...
                                _SectionCard(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      _StatRow(
                                        label: 'Admins',
                                        value: _statistics!['users']?['admins']
                                                ?.toString() ??
                                            '0',
                                      ...
                                      _StatRow(
                                        label: 'Members',
                                        value: _statistics!['users']?['members']
                                                ?.toString() ??
                                            '0',
                                      ...
                                      _StatRow(
                                        label: 'Active',
                                        value: _statistics!['users']?['active']
                                                ?.toString() ??
                                            '0',
                                        valueColor: Colors.green,
                                      ),
                                      _StatRow(
                                        label: 'Online',
                                        value: _statistics!['users']?['online']
                                                ?.toString() ??
                                            '0',
  ...
  @override
  void dispose() {
    WindowManagerHelper.setTransparencyLocked(
        false); // Restore transparency capability
    super.dispose();
  }
}
