                      ...
                      children: [
                        ListTile(
                          leading: CircleAvatar(
                            backgroundColor: global_theme
                                .AppTheme.darkOnyx.accentColor
                                .withOpacity(0.2),
                            child: Text(
                    ...
                    return Column(
                      children: [
                        RadioListTile<String>(
                          ...
                          activeColor:
                              global_theme.AppTheme.darkOnyx.accentColor,
                          onChanged: (val) {
                            if (val != null) {
                              ref
                ...
                child: Column(
                  children: [
                    RadioListTile<String>(
                      ...
                      subtitle: const Text(
                          "Requires internet. Best for complex medical terms."),
                      value: 'groq',
                    ...
                    RadioListTile<String>(
                      ...
                      subtitle: const Text(
                          "Real-time streaming via Oracle AI (me-riyadh-1). Recommended."),
                      value: 'oracle_live',
                      groupValue: _sttEnginePref,
              ...
              child: ListTile(
                leading: Container(
                  ...
                  decoration: BoxDecoration(
                      color: global_theme.AppTheme.darkOnyx.accentColor
                          .withOpacity(0.2),
