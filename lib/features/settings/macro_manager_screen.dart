...
class _MacroManagerScreenState extends State<MacroManagerScreen> {
  final MacroApiService _service = MacroApiService();
  List<Macro> _macros = [];
  ...
  Future<void> _loadMacros() async {
    ...
    final data = await _service.fetchMacros();
    setState(() {
      _macros = data;
      _isLoading = false;
    });
                  ...
                  children: [
                    ...
                    ...macrosInSection.map((m) {
                        return Dismissible(
                          ...
                          onDismissed: (_) async {
                            await _service.deleteMacro(m.id.toString());
                            _loadMacros(); 
                          },
                          child: Card(
                            ...
                            child: ListTile(
                              leading: IconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  await _service.toggleFavorite(m.id.toString());
