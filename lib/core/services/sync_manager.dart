  ...
  Future<void> _syncItem(SyncItem item) async {
    switch (item.operation) {
      case SyncOperation.create:
        await _ApiClient.post(item.endpoint, body: item.data);
        break;

      case SyncOperation.update:
        await _ApiClient.put(item.endpoint, body: item.data);
        break;
      ...
      case SyncOperation.patch:
        await _ApiClient.patch(item.endpoint, body: item.data);
        break;
    }
  }
