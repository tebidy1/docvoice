...
import 'package:soutnote/utils/wav_utils.dart';
import 'package:soutnote/core/models/note_model.dart';
import 'macro_api_service.dart';
...
class ConnectivityServer {
  ...
  // Services
  final MacroApiService _macroService = MacroApiService();
        ...
        (message) async {
          if (message is List<int>) {
            ...
            if (message == "START_RECORDING") {
              ...
              final macroString = jsonEncode(macros.map((m) => m.toJson()).toList());
              webSocket.sink.add(macroString);
