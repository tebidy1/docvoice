...
class MacroService {
  ...
  Future<void> deleteMacro(int id) async {
    await init();
    try {
      final response = await _ApiClient.delete('/macros/$id');
  ...
  Future<void> toggleFavorite(int id) async {
    await init();
    try {
      final response = await _ApiClient.patch('/macros/$id/toggle-favorite');
  ...
  Future<List<Macro>> getMacrosByCategory(String category) async {
    await init();
    try {
      final response = await _ApiClient.get('/macros/category/$category');
  ...
  Future<List<String>> getCategories() async {
    await init();
    try {
      final response = await _ApiClient.get('/macros/categories');
  ...
  Future<List<Macro>> getFavorites() async {
    await init();
    try {
      final response = await _ApiClient.get('/macros/favorites');
