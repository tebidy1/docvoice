...
class ArchiveScreen extends StatelessWidget {
  ...
  const ArchiveScreen(
      {super.key, required this.archivedNotes, required this.onClearAll});
            ...
            IconButton(
              ...
              onPressed: () async {
                ...
                if (confirm == true) {
                  onClearAll();
                  Navigator.pop(
                      context); // Close screen or stay? Usually stay is fine if list empties.
                }
              },
            ),
        ],
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Card(
                      ...
                      color: MobileAppTheme.surface.withOpacity(0.6),
                      child: ListTile(
                        contentPadding: const EdgeInsets.symmetric(
                            horizontal: 16, vertical: 8),
                        leading:
                            const Icon(Icons.archive, color: Colors.white30),
