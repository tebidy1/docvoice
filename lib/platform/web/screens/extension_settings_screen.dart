            ...
            Card(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    RadioListTile<String>(
                      title: Text("High-Speed Dictation (Cloud)",
                          style: TextStyle(
                              color: Theme.of(context)
                                  .textTheme
                                  .bodyLarge
                    ...
                    RadioListTile<String>(
                      title: Text("Offline Draft Mode (Built-in)",
                          style: TextStyle(
                              color: Theme.of(context)
                                  .textTheme
                                  .bodyLarge
                                  ?.color)),
                      subtitle: Text(
                          "Basic transcription using device's internal engine.",
                          style: TextStyle(
                              color: Theme.of(context)
                                  .textTheme
                                  .bodySmall
                    ...
                    RadioListTile<String>(
                      title: Text("Specialized Medical Dictation",
                          style: TextStyle(
                              color: Theme.of(context)
                                  .textTheme
                                  .bodyLarge
                    ...
                    RadioListTile<String>(
                      title: Text("✨ Smart Magic Flow (Recommended)",
                          style: TextStyle(
                              color: Theme.of(context)
                                      .textTheme
                                      .bodyLarge
                                  ...
                                  Colors.amber)),
                      subtitle: Text(
                          "Max speed! Audio maps directly to final formatted note.",
                          style: TextStyle(
                              color: Theme.of(context)
                                  .textTheme
                                  .bodySmall
