                      ...
                      Expanded(
                        child: ListView(
                          ...
                          children: [
                            ...
                            _buildMenuItem(
                              icon: MedicalDepartments.getById(
                                          DepartmentService().value)
                                      ?.icon ??
                                  Icons.local_hospital,
                              label: "Medical Department",
                              subtitle: MedicalDepartments.getById(
                                          DepartmentService().value)
                                      ?.nameEn ??
                            ...
                            const SizedBox(height: 16),
                            _buildSectionHeader(
                                "Speech-to-Text Engine", currentTheme),
                            _buildSttItem(
                            ...
                            _buildSttItem(
                              ...
                              subtitle:
                                  "Skip transcription! Audio + Template → Final Note in 1 step.",
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle:
                            TextStyle(color: theme.iconColor.withOpacity(0.5)),
