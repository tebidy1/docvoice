...
import 'package:soutnote/data/models/dto/macro_dto.dart';
...
class ApiMacroRepository extends AbstractApiRepository<Macro>
  ...
  Future<List<Macro>> getByCategory(String category) async {
    try {
      final response = await _ApiClient.get('$endpoint/category/$category');
  ...
  Future<List<Macro>> getFavorites() async {
    try {
      final response = await _ApiClient.get('$endpoint/favorites');
  ...
  Future<void> toggleFavorite(String id) async {
    try {
      final response = await _ApiClient.patch('$endpoint/$id/toggle-favorite');
  ...
  Future<void> incrementUsage(String id) async {
    try {
      final response = await _ApiClient.patch('$endpoint/$id/increment-usage');
  ...
  Future<List<String>> getCategories() async {
    try {
      final response = await _ApiClient.get('$endpoint/categories');
