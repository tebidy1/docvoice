...
import 'package:soutnote/data/services/macro_service_api.dart';
import 'package:http/http.dart' as http;
import 'package:soutnote/core/medical_departments.dart';
import 'package:soutnote/data/services/department_service.dart';
  ...
  Future<AIProcessingResult> processNote({
    ...
    try {
      ...
      if (response['status'] == true) {
        ...
        // - Fast mode:   { text: "..." }
        final formattedNote = payload['final_note'] as String? ??
