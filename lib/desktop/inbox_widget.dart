...
class InboxWidget extends StatefulWidget {
  ...
  const InboxWidget({super.key, required this.isExpanded, required this.onToggle});
...
class _InboxWidgetState extends State<InboxWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<InboxNote>>(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: count > 0 ? Colors.orange.withOpacity(0.6) : Colors.white10),
                  boxShadow: [
                    BoxShadow(
          ...
          child: Material(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                  left: BorderSide(color: Colors.amber.withOpacity(0.3), width: 2),
                ),
              ),
              child: Column(
                children: [
