...
import 'package:soutnote/core/models/inbox_note.dart'; // Import NoteModel and NoteStatus
...
import 'package:soutnote/desktop/inbox_manager_dialog.dart';
import 'package:soutnote/desktop/inbox_note_detail_view.dart'; // Import Detail View for instant open
import 'package:soutnote/desktop/macro_manager_dialog.dart';
...
class _DesktopAppState extends ConsumerState<DesktopApp> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      final notes = await ref.read(inboxNoteRepositoryProvider).getAll();
      if (mounted) {
        setState(() {
  ...
  Future<void> _startServer() async {
    ...
    _server.textStream.listen((text) async {
      ...
      try {
        ...
        await ref.read(inboxNoteRepositoryProvider).create(note);
                    ...
                    child: ClipRRect(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: theme.borderColor, width: 1), // From Theme
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            StreamBuilder<List>(
                              stream: ref
                                  .watch(inboxNoteRepositoryProvider)
                                  .watch(),
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    color: _isRecording
                                        ...
                                        : theme.micIdleBackground, // From Theme
                                    borderRadius: BorderRadius.circular(
                                        4), // Spec: 4px radius
                                    border: Border.all(
                                        color: _isRecording
                                            ? theme.micRecordingBorder
                                            : theme.micIdleBorder, // From Theme
                                        width: 1),
                                  ),
                                  child: _isProcessing
                                      ? Padding(
